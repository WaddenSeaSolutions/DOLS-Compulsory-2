...
- Create Angular project with ng: `ng new dols-compulsory-2.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dols-compulsory-2.client.esproj`).
